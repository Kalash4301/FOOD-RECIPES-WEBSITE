    ...
    <div class="modal-dialog modal-dialog-centered">
      <div class="modal-content">
       ...
       <div class="modal-body">
          ...
          <input type="text" class="form-control" id="validationCustomUsername" placeholder="Name" name="name" aria-describedby="inputGroupPrepend" required>
      ...
      <input type="number" class="form-control" size="2" id="validationCustomUsername" placeholder="age" name="age" aria-describedby="inputGroupPrepend" required>
     <div class="invalid-feedback">
